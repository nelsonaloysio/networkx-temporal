...
def in_degree(
    ...
    Defined [1]__ for temporal graphs as the in-degree sum over time:
...
def out_degree(
    ...
    Defined [1]__ for temporal graphs as the out-degree sum over time:
...
def degree_centrality(
    ...
    Defined [1]__ as the fraction of connected nodes, i.e.,

...
from .dynamic_sbm import dynamic_stochastic_block_model, DISTRIBUTION
...
def stochastic_block_model(
    ...
    ``distribution='bernoulli'``) distribution based on community memberships and degree-correction
    factors, with probabilities
    ...
    .. seealso::
        ...
        The `graph-tool <https://graph-tool.skewed.de>`__ library, which provides efficient
    ...
    .. code-block:: python
        ...
        MultiGraph with 44 nodes and 89 edges
    ...
    :note: Wrapper for :func:`~networkx_temporal.generators.dynamic_stochastic_block_model`
        with ``t=1``.
    """

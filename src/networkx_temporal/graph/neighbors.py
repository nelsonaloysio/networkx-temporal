...
def all_neighbors(TG: TemporalGraph, node: Any) -> iter:
    """
    Returns list of all node neighbors in all snapshots. Does not consider edge direction.
...
def neighbors(TG: TemporalGraph, node: Any) -> iter:
    """
    Returns list of node neighbors in all snapshots. Considers edge direction.

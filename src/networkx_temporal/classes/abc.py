...
class TemporalABC(metaclass=ABCMeta):
    ...
    def empty_graph(self) -> StaticGraph:
        """
        Returns an empty static graph with the same properties.
        """
